...
var resultVariable = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/ResultVariable');
...
function isSupportedCallableType(type) {
  ...
  return [ 'cmmn', 'dmn' ].indexOf(type) !== -1;
}
